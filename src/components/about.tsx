...
export function About() {
  return (
    ...
    >
      <div className="mx-auto grid max-w-[1440px] gap-10 px-4 py-16 sm:px-6 sm:py-20 md:grid-cols-12 md:gap-10 md:px-10 md:py-28">
        <div className="md:col-span-5">
          <p className="font-display text-[11px] tracking-[0.42em] text-amber uppercase">
            02 / About TechX
          </p>
          <h2 className="font-display mt-5 max-w-md text-[clamp(1.85rem,5vw,3.75rem)] leading-[1.05] font-semibold tracking-tight">
        ...
        <div className="md:col-span-7 md:max-w-2xl md:justify-self-end">
          ...
          <div className="mt-8 space-y-5 text-base leading-8 text-brown-soft sm:text-lg sm:leading-8">
            <p>
        ...
        <dl className="col-span-full grid gap-6 border-y border-amber/30 py-8 sm:grid-cols-2 lg:grid-cols-4">
          {facts.map((fact) => (
            <div key={fact.label}>
        ...
        <figure className="relative aspect-3/4 overflow-hidden bg-brown sm:aspect-4/5 md:col-span-5 md:aspect-auto md:min-h-[28rem]">
          <Image
        ...
        <aside className="flex flex-col justify-end md:col-span-7 md:pl-10 lg:pl-16">
          ...
          <a
            ...
            className="font-display mt-8 inline-flex text-[11px] tracking-[0.28em] text-amber uppercase"
          >
            Explore chapter →
          </a>
        </aside>
